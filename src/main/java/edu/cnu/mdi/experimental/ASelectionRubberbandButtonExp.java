...
public abstract class ASelectionRubberbandButtonExp extends JToggleButton
    ...
    protected ASelectionRubberbandButtonExp(Component canvas, AToolBar toolBar,
                                            Rubberband.Policy policy, int minSizePx) {
    ...
    protected Object doubleClickHitTest(Point p) {
        return null;
    }
    ...
    protected void simplePress(Point p, boolean isAdd) {
        // default no-op
    }

    /** Click on an object (no drag). */
    ...
    private boolean isAddModifier(MouseEvent e) {
        ...
        return e.isShiftDown()
                ...
                || (m & InputEvent.META_DOWN_MASK) != 0; // mac
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        // Only handle true double-clicks.
        if (e.getClickCount() != 2) {
            return;
        }

        // Optional: require left button.
        // Note: on some platforms, getButton() can be 0 for click events.
        // If you hit that, remove this check.
        ...
        Object dc = doubleClickHitTest(e.getPoint());
        if (dc != null) {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        try {
            if (mode == Mode.PRESS_ON_OBJECT) {
                ...
                simplePress(e.getPoint(), isAddModifier(e));
