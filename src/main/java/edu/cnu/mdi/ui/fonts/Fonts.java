 ...
 * <p>
 * With FlatLaf, the correct "common" font is the LookAndFeel default font (UI
 * key "defaultFont"). This class derives all application fonts from that base
 * font to ensure consistent typography across platforms and themes.
 * </p>
 */
public final class Fonts {
	...
	public static void refresh() {
		...
		// This keeps Windows/macOS/Linux looking “right” under FlatLaf.
	...
	/**
	 * Returns the current base UI font from UI defaults (FlatLaf uses
	 * "defaultFont"). :contentReference[oaicite:5]{index=5}
	 */
	...
	/**
	 * Convenience method to derive a plain font from BASE_UI_FONT using a size
