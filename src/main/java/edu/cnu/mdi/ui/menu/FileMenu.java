 ...
 *
 * <p>Provides actions for saving/deleting the view configuration
 * and quitting the application. All accelerator key masks avoid
 * deprecated AWT APIs.</p>
 *
 * @author heddle
 */
...
public class FileMenu extends JMenu {
     ...
     *
     * @param includeConfigurationItems whether to include
    ...
    /** Determine platform-appropriate shortcut key (Command on macOS, Control elsewhere). */
