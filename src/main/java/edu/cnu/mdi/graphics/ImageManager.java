...
public class ImageManager {
	...
	private static ImageIcon _dialogIcon = ImageManager.getInstance().loadImageIcon("images/mdiicon.png");
	...
	/**
	 * Get the icon used in dialogs
	 * @return icon used in dialogs
	 */
	...
	/**
	 * Set the icon used in dialogs
	 * @param icon the icon used in dialogs
	 */
