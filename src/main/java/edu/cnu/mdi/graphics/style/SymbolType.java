...
public enum SymbolType {
	NOSYMBOL("No Symbol"), SQUARE("Square"), CIRCLE("Circle"), CROSS("Cross"), UPTRIANGLE("Up Triangle"),
	DOWNTRIANGLE("Down Triangle"), X("X"), BOWTIE("Bow Tie"), DIAMOND("Diamond"), STAR("Star");
