 ...
 * (smaller, shifted up) + : bigger font - : smaller font s : small horizontal
 * space S : big horizontal space
 */
public class Snippet {
	...
	public void drawSnippet(Graphics g, int xo, int yo, double angleDegrees) {
		GraphicsUtils.drawRotatedText((Graphics2D) g, text, font, xo, yo, deltaX, deltaY, angleDegrees);
	}
