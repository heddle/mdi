 ...
 * {@link ToolContext}, so this class snapshots the necessary state at the
 * start of completion to avoid NPEs and re-entrancy issues.
 * </p>
 */
public abstract class AbstractLineRubberbandTool implements ITool, IRubberbanded {
    ...
    /** @return the rubberband policy to use (typically {@link Rubberband.Policy#LINE}). */
