 ...
 * hover-driven tools), proceeds through zero or more updates, and ends on release
 * or exit. This class packages:
 * </p>
 * <ul>
 ...
 *   <li>Modifier key state (shift/ctrl/alt/meta) as of the most recent update</li>
 * </ul>
 *
