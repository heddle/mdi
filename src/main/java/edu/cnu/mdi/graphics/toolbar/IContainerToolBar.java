...
public interface IContainerToolBar {
 ...
 // ------------------------------------------------------------
    ...
    /**
     * Register a tool and add it as a mutually-exclusive toggle button.
     * Default implementation does nothing, so containers can use other toolbars.
     */
    ...
    /**
     * Add a one-shot action button (not part of the toggle group).
