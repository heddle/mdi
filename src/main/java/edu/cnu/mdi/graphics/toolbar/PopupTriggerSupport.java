...
/**
 * Utility for handling platform-specific popup triggers (context menus) on a
 * view/canvas.
 * <p>
 * The policy mirrors the legacy {@code ToolBarToggleButton.popupTrigger(...)}
 * behavior:
 * </p>
 * <ol>
 * <li>If an item exists under the cursor and is right-clickable, show the item
 * popup.</li>
 ...
 * In the old code this was the button ("this"). In the new framework it should
 * be the container's canvas component (or any component in the same hierarchy).
 * </p>
 *
...
public final class PopupTriggerSupport {
	 ...
	 * <p>
	 * On some platforms the popup trigger occurs on press; on others it occurs on
	 * release. Call this check from both handlers if you want fully correct
	 * behavior.
	 * </p>
	 *
	 ...
	 * <p>
	 * Uses the container's view, item-under-cursor, and view popup menu according
