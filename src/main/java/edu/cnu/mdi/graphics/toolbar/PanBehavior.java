 ...
 * <p>
 * In the old framework, panning customization leaked into {@code PanButton}
 * and required hacks such as {@code container.isStandardPanning()}.
 * </p>
 * <p>
 ...
 *   <li>preview-image panning that visually drags a snapshot and commits once</li>
 *   <li>map-specific panning rules (wrap-around longitude, constrained axes, etc.)</li>
 * </ul>
 *
 * @author heddle
 */
