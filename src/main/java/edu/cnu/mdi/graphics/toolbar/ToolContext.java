 ...
 * <p>
 * Tools should not depend on Swing toolbar button subclasses or reach broadly into
 * UI classes to obtain dependencies. Instead, any runtime services a tool needs
 * (container, canvas component, toolbar) are provided via this context.
 * </p>
 * <p>
 ...
 * <h2>Popup support</h2>
 * <p>
 * Tools generally should not handle context menus themselves; popups are best handled
 * centrally by the mouse router (the toolbar/controller). However, this context provides
 * a convenience method if a tool needs to request the standard popup policy.
 * </p>
 *
 * @author heddle
 */
public class ToolContext {
     ...
     *
     * @param container the container that owns the canvas and provides interaction hooks.
     * @param toolBar   the owning toolbar (may be useful for status text and UI coordination).
     */
	 ...
	 */
    public CursorManager cursors() { return cursors; }

    /**
     * Request that the standard popup policy be applied for the given event.
     * <p>
     * Prefer handling popups centrally in {@link BaseToolBar}, but this is available
     * for tools that explicitly need it.
     * </p>
     *
