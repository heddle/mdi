...
public final class CursorManager {
	 ...
	 * </p>
	 *
	 * @param resourcePath classpath/resource path understood by
	 *                     {@link ImageManager} (e.g.
	 *                     {@code "images/pointercursor.gif"}). Must not be null.
	 ...
	 *
	 * @return a cached/created custom cursor, or the default cursor if creation
	 *         fails.
	 */
	 ...
	 * <p>
	 * Normally you never need this, but it can be useful during development if
	 * cursor resources are changing.
	 * </p>
	 */
	public void clear() {
		cache.clear();
