 ...
 * snapshot is drawn offset from its starting position to provide a smooth visual
 * preview without continuously updating the container's world transform.
 * </p>
 * <p>
 * On mouse release, the pan is committed exactly once via
 * {@link edu.cnu.mdi.container.IContainer#pan(int, int)} using the total
 * drag delta from the initial press.
 * </p>
 * <p>
