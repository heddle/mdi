...
public final class ToolBarBits {
	...
	public static final long EVERYTHING = STYLEBUTTON | ELLIPSEBUTTON | TEXTBUTTON | RECTANGLEBUTTON | POLYGONBUTTON
			| LINEBUTTON | DELETEBUTTON | STATUSFIELD | CENTERBUTTON | UNDOZOOMBUTTON | RADARCBUTTON | POLYLINEBUTTON
	...
	public static final long DRAWING = EVERYTHING & ~MAGNIFYBUTTON;
	...
	/**
	 * Only the text drawing tool (plus whatever non-drawing widgets you keep in
	 * STANDARD).
	 */
