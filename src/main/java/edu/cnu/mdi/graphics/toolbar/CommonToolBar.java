...
public class CommonToolBar extends JToolBar {
	 ...
	 * @throws IllegalArgumentException if the button is not contained in this
	 *                                  toolbar.
	 */
	...
	/**
	 * Backward-compatible alias for {@link #addToggle(JToggleButton)}. Prefer
	 * {@link #addToggle(JToggleButton)} to avoid confusion with
	 * {@link #add(Component)}.
	 *
	...
	/**
	 * Backward-compatible alias for {@link #removeToggle(JToggleButton)}. Prefer
	 * {@link #removeToggle(JToggleButton)}.
	 *
