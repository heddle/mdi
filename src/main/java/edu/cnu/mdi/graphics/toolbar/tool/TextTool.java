 ...
 * </p>
 * <ul>
 * <li>On mouse click, shows a {@link LabelDialog} to collect text + font +
 * colors.</li>
 * <li>Applies {@link UnicodeSupport#specialCharReplace(String)} to the entered
 * text.</li>
 * <li>If non-empty, creates a {@link TextItem} at the clicked world coordinate
 * in the container's annotation list.</li>
 * <li>Configures the item as
 * draggable/rotatable/resizable/deletable/right-clickable.</li>
...
public class TextTool implements ITool {
	...
	/**
	 * Show the label dialog and, if valid text/font are chosen, create a
	 * {@link TextItem} at the clicked world point.
	 */
	@Override
	public void mouseClicked(ToolContext ctx, MouseEvent mouseEvent) {
		...
		TextItem item = new TextItem(ctx.container().getAnnotationLayer(), wp, font, resultString,
	...
	/**
	 * Common post-action behavior: clear selection, return to default tool,
	 * refresh.
	 */
