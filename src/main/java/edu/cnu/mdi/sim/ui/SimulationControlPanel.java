...
/**
 * A reusable Swing control panel for driving a simulation hosted by an
 * {@link ISimulationHost}.
 * <p>
...
public class SimulationControlPanel extends JPanel implements SimulationListener, ISimulationControlPanel {
	...
	/**
	 * Create an unbound control panel. Call {@link #bind(ISimulationHost)} to
	 * attach it.
	 */
	...
	private void applyState(SimulationState state, String reason) {
		...
		// Button enable rules:
		// - Start is useful anytime before a thread exists; engine.start() is
		// idempotent.
