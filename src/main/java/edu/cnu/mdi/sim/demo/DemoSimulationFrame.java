...
/**
 * Tiny Swing demo that exercises the simulation framework without any MDI dependencies.
 * <p>
 * It shows:
 * <ul>
    ...
    public DemoSimulationFrame() {
        ...
        engine.addListener(new SimulationListener() {
            ...
            public void onRefresh(SimulationContext ctx) {
                // here you would repaint a view; demo just shows determinate progress computed from stepCount
