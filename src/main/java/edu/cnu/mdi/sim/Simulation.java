 ...
 * <p>
 * A {@code Simulation} contains no UI code. It runs entirely on the simulation
 * thread. It can request UI updates via
 * {@link SimulationEngine#requestRefresh()} and
 * {@link SimulationEngine#postProgress(ProgressInfo)} /
 * {@link SimulationEngine#postMessage(String)}.
 * </p>
 */
public interface Simulation {

	/**
	 * Initialize simulation resources. Called exactly once on the simulation
	 * thread.
	 *
	...
	/**
	 * Execute a single step of the simulation. Called repeatedly on the simulation
