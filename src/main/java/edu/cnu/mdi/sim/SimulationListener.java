...
/**
 * Listener interface for simulation lifecycle, state, UI refresh, and progress events.
 * <p>
 * All listener callbacks are executed on the AWT/Swing Event Dispatch Thread (EDT),
 * so it is safe to update UI components directly inside these methods.
 * </p>
 * <p>
 * Implementers can override only the methods they care about; all methods are default no-ops.
 * </p>
 */
public interface SimulationListener {
    ...
    /**
     * Called when initialization completes and the engine reaches {@link SimulationState#READY}.
     *
     * @param ctx simulation context
     */
    ...
    /**
     * Called when the engine begins execution (enters {@link SimulationState#RUNNING}).
     *
     * @param ctx simulation context
     */
    ...
    /**
     * Called when the engine resumes from {@link SimulationState#PAUSED} back to {@link SimulationState#RUNNING}.
     *
     * @param ctx simulation context
     */
    ...
    /**
     * Called when the engine ends normally (reaches {@link SimulationState#TERMINATED}).
     *
     * @param ctx simulation context
     */
    ...
    /**
     * Called when cancellation is requested via {@link SimulationEngine#requestCancel()}.
     * <p>
    ...
    /**
     * Called for a graphics refresh/update event. Views typically repaint in response.
     *
     * @param ctx simulation context
     */
