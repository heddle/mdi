...
/**
 * Immutable progress payload for progress updates delivered to {@link SimulationListener}.
 * <p>
 * Supports determinate progress (0..1 fraction) and indeterminate progress (spinner).
 * A message may be provided for UI display.
 * </p>
 */
public final class ProgressInfo {
    ...
    /**
     * Determinate progress fraction in the range [0,1]. Ignored if {@link #indeterminate} is true.
     */
