 ...
 * This renderer:
 * <ul>
 *   <li>Loops over latitude and longitude ranges using configurable step sizes.</li>
 *   <li>Delegates actual drawing to the projection's
 *       {@link IMapProjection#drawLatitudeLine(Graphics2D, IContainer, double)}
 *       and
...
public final class GraticuleRenderer {
    ...
    /**
     * Renders the map outline (optionally) and graticule lines using the
     ...
     * </ul>
     * Individual projections may choose to ignore lines that fall outside
     * their valid domain (for example, a limited-area projection).
     * </p>
     *
