 ...
 * a 64-bit {@code long}. This class provides common operations such as checking,
 * setting, clearing, toggling individual bits or masks, identifying the
 * positions of the first or highest set bit, counting bits, and constraining a
 * mask to a fixed width.
 *
 * <p>
...
public final class Bits {
     ...
     *
     * <p>Example: to test whether bit 5 is set:</p>
     * <pre>
    ...
    /**
     * Returns a value in which all bits specified by {@code mask} have been set
     * to {@code 1}, leaving all other bits unchanged.
     *
    ...
    /**
     * Returns a value in which all bits specified by {@code mask} have been
     * cleared (set to {@code 0}), leaving all other bits unchanged.
     *
    ...
    /**
     * Returns a value in which all bits specified by {@code mask} have been
     * toggled (flipped from {@code 0} to {@code 1} or {@code 1} to {@code 0}).
     *
     * @param bits the original value
    ...
    /**
     * Returns the index (0-based) of the lowest set bit (LSB-first). That is,
     * it returns the position of the first bit whose value is {@code 1}.
     *
     * <p>This method is equivalent to
     * {@link Long#numberOfTrailingZeros(long)} when {@code bits != 0}.</p>
     *
    ...
    /**
     * Returns the index (0-based) of the highest set bit (MSB-first). That is,
     * it returns the position of the most significant bit whose value is {@code 1}.
     *
     * <p>This method is equivalent to:
     * <pre>
     ...
     *
     * <p>This method delegates to {@link Long#bitCount(long)}.</p>
     *
     * @param bits the 64-bit word
    ...
    /**
     * Returns the value of {@code bits} truncated to a field of width
     * {@code width} bits (from the least significant side).
     *
     * <p>
     * If {@code width <= 0}, the method returns {@code 0L}. If
     * {@code width >= 64}, the method returns {@code bits} unchanged.
     * </p>
     *
     * <p>
