 ...
 *
 * <p>These helpers simplify the process of generating snapshots of components
 * for thumbnails, drag images, buffered painting, effects, and testing.
 * Unlike {@link Component#createImage(int, int)}, these methods return a
 * {@link BufferedImage} that can be manipulated, saved, or inspected.</p>
 *
 * <p>All methods are null-safe and return {@code null} if the given component
 * is {@code null} or has an invalid size.</p>
 *
 * <p><strong>Important:</strong> The component must have a meaningful size
 * (usually after layout or manual sizing) before rendering can occur.</p>
 */
public final class SwingGraphicsUtils {
     ...
     *
     * <p>This method does not paint anything; it only allocates a
     * {@link BufferedImage} of type {@link BufferedImage#TYPE_INT_RGB}.
     * Use {@link #paintComponentOnImage(Component, BufferedImage)} to draw
     * the component.</p>
     *
     ...
     *
     * <p>This uses {@link BufferedImage#TYPE_INT_ARGB}, which preserves alpha
     * and allows semi-transparent rendering. Useful for drag images, effects,
     * or components with non-opaque backgrounds.</p>
     *
     * @param c the component whose size determines the buffer dimensions
     ...
     *
     * <p>This uses {@link Component#paint(java.awt.Graphics)} which performs
     * the component's full paint cycle (background, border, children, etc.).
     * The component does not need to be visible on screen.</p>
     *
    ...
    /**
     * Convenience method that creates an opaque buffer and immediately paints
     * the component into it.
     *
     * <p>Useful for quickly generating snapshots for saving or testing.</p>
     *
     * @param c the component to render
     ...
     *
     * <p>This preserves transparency and is appropriate for overlays, effects,
     * or drag-and-drop representations.</p>
     *
     * @param c the component to render
