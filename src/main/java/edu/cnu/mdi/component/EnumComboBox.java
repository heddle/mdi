...
/**
 * A JComboBox backed directly by enum values, with optional extra choice
 * (e.g. "Any" or "None") and customizable labels.
 *
...
public class EnumComboBox<E extends Enum<E>> extends JComboBox<E> {
    ...
    /**
     * Create a combo box that lists all constants of the given enum type,
     * using {@link Enum#name()} as the label.
     *
    ...
    /**
     * Create a combo box that lists all constants of the given enum type,
     * with an optional extra choice (e.g. "Any") and a custom label provider.
     *
     * @param enumType        the enum class
     * @param extraChoiceLabel label for a non-enum choice at the top, or null for none
    ...
    /**
     * Get the selected enum value. Returns {@code null} if the extra
     * choice was used and is selected.
     *
