 ...
 * default renderer for columns of class Icon and ImageIcon, is known to give
 * rise to a ClassCastException when attempting to render an Icon whose
 * implementation of paintIcon(Component c, Graphics g, int x, int y) requires a
 * cast of its first parameter to a specific subclass of Component. Many icons
 * obtained from standard JDK classes trigger this ClassCastException.
 * <P>
 ...
 * <LI>All else failing, the icon is rendered as a crossed rectangle of the same
 * size as the original icon, or the default icon if supplied as a parameter to
 * the constructor.</LI>
 * <P>
...
public class IconTableCellRenderer extends DefaultTableCellRenderer {
	...
	private Color getCorrectBackground(JTable table, boolean isSelected) {
		return isSelected ? null : table.getBackground();
	}
