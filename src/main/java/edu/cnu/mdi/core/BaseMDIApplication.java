...
import edu.cnu.mdi.swing.view.ViewPropertySupport;
...
public class BaseMDIApplication extends JFrame {
	...
	protected BaseMDIApplication(Object... keyVals) {
		...
		MenuManager menuManager = new MenuManager(getJMenuBar());
		...
		Color background = ViewPropertySupport.getBackgroundColor(_properties);
		String backgroundImage = ViewPropertySupport.getBackgroundImagePath(_properties);
		String title = ViewPropertySupport.getTitle(_properties);
		boolean maximize = ViewPropertySupport.isMaximize(_properties);
		double screenFraction = ViewPropertySupport.getFraction(_properties);
		int width = ViewPropertySupport.getWidth(_properties);
		int height = ViewPropertySupport.getHeight(_properties);
