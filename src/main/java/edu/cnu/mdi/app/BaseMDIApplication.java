 ...
 * <ul>
 * <li>Call {@link #prepareForVirtualDesktop()} if virtual desktop support is
 * desired</li>
...
public class BaseMDIApplication extends JFrame {
	 ...
	 * accepts a variable-length list of property key-value pairs used to configure
	 * frame size, title, background, etc.
	 *
