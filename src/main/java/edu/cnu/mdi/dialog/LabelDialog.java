...
/**
 * Dialog for entering a text label and selecting its font style/size and
 * colors.
 * <p>
...
public class LabelDialog extends JDialog implements ListSelectionListener, ItemListener {
	...
	// possible font sizes
	private final String[] fontSizes = { " 8 ", " 10 ", " 11 ", " 12 ", " 14 ", " 16 ", " 18 ", " 20 ", " 24 ", " 30 ",
			" 36 ", " 40 ", " 48 ", " 60 ", " 72 " };
	...
	/**
	 * Construct the dialog using an input font as the base. The font family is
	 * taken from {@code inFont} and is not user-selectable.
	 */
	...
	protected void previewFont() {
		...
		// Preserve family from input font; this keeps typography consistent with
		// FlatLaf.
