...
public class Axes3D extends Item3D {
	 ...
	 * @param numTicksY the number of major ticks in y
	 * @param numTicksZ the number of major ticks in z
	 ...
	 * @param numDec    the number of decimals to display
	 */
	public Axes3D(Panel3D panel3D, float xmin, float xmax, float ymin, float ymax, float zmin, float zmax,
			String labels[], Color color, float lineWidth, int numTicksX, int numTicksY, int numTicksZ, Color tickColor,
			Color textColor, Font font, int numDec) {
		this(panel3D, Support3D.toArray(xmin, xmax, ymin, ymax, zmin, zmax), labels, color, lineWidth, numTicksX,
	 ...
	 */
	public Axes3D(Panel3D panel3D, float xmin, float xmax, float ymin, float ymax, float zmin, float zmax,
			String labels[], float zoff, Color color, float lineWidth, int numTicksX, int numTicksY, int numTicksZ,
