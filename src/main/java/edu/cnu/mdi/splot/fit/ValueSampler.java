...
/**
 * Utility methods for sampling {@link Evaluator} functions for plotting or
 * further analysis.
 */
public final class ValueSampler {
	 ...
	 */
	public static double[][] sampleUniform(Evaluator f, double xmin, double xmax, int n) {
	...
	/**
	 * Sample uniformly, skipping non-finite results (NaN/Inf). Useful when plotting
	 * functions that may blow up at the edges.
	 *
	 * @param f    function
	 * @param xmin minimum x
	 * @param xmax maximum x
	 ...
	 */
	public static double[][] sampleUniformFinite(Evaluator f, double xmin, double xmax, int n) {
