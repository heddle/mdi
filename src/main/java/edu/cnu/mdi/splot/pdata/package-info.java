 ...
 * </p>
 * <ul>
 *   <li>{@link edu.cnu.mdi.splot.pdata.ACurve} – the abstract base class for all curves</li>
 *   <li>{@link edu.cnu.mdi.splot.pdata.Curve} – standard XY curves with optional Y-errors</li>
 *   <li>{@link edu.cnu.mdi.splot.pdata.HistoCurve} – histogram-backed curves</li>
 *   <li>Supporting data containers such as {@link edu.cnu.mdi.splot.pdata.DataColumn} and
 ...
 *
 * <p>
 * To support modern streaming and data-acquisition use cases, {@link edu.cnu.mdi.splot.pdata.Curve}
 * and {@link edu.cnu.mdi.splot.pdata.HistoCurve} provide thread-safe data addition methods:
 * </p>
 * <ul>
